...
def main():
    ...
    network = xception(num_classes=2, pretrained=False).cuda()
    #network = torch.nn.DataParallel(network)
    model_path = './RFM/dffd_xception_model-RFM'
    #model_path = "/home/likaide/sda4/wxs/pycharm/tmp/pycharm_project_wxs/Detecors/results/xception_2023_07_19_12_23_37/models/xception_face_epoch16.pth"
