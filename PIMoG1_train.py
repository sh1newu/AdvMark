...
def main():
    ...
    project_name = "PIMoG1"  # xception/resnet18/resnet50
    ...
    train_dataset = ImgDataset2(os.path.join(dataset_path, "AdvMark/train/Real/*.png"),
                               os.path.join(dataset_path, "AdvMark/train/Fake/*/*.png1"), 256)
    ...
    train_dataset = ImgDataset2(os.path.join(dataset_path, "AdvMark/val/Real/*.png"),
                               os.path.join(dataset_path, "AdvMark/val/Fake/*/*.png1"), 256)
    ...
    for epoch in range(1, epoch_number + 1):
        ...
        for step, (image, label) in enumerate(train_dataloader, 1):
            ...
            g_loss = 1 * g_loss_on_encoder + 3 * g_loss_on_decoder + 0.001 * g_loss_on_discriminator
        ...
        with torch.no_grad():
            ...
            for step, (image, label) in enumerate(val_dataloader, 1):
                ...
                g_loss = 1 * g_loss_on_encoder_LPIPS + 3 * g_loss_on_decoder
